  ...
  return (
    <button
      className={cn(
        ...
        variant === "secondary" && "border-border/80 bg-muted/78 text-foreground hover:bg-muted",
        variant === "ghost" && "border-transparent bg-transparent text-foreground hover:bg-muted/68",
        variant === "outline" && "border-border/80 bg-background/55 text-foreground hover:bg-muted/70",
